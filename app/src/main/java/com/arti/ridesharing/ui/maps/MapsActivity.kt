...
import com.arti.ridesharing.data.network.NetworkService
import com.arti.ridesharing.utils.AnimationsUtils
import com.arti.ridesharing.utils.AnimationsUtils.cabAnimator
import com.arti.ridesharing.utils.AnimationsUtils.polyLineAnimator
import com.arti.ridesharing.utils.MapsUtils
import com.arti.ridesharing.utils.MapsUtils.getCarBitmap
import com.arti.ridesharing.utils.MapsUtils.getDestinationBitmap
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, MapsView {
    ...
    override fun showPath(latLngList: List<LatLng>) {
        ...
        val polylineAnimator = AnimationsUtils.polyLineAnimator()
    ...
    override fun updateCabLocation(latLng: LatLng) {
        ...
        if (previousLatLngFromServer == null) {
            ...
            previousLatLngFromServer = currentLatLngFromServer
            currentLatLngFromServer = latLng
            val valueAnimator = AnimationsUtils.cabAnimator()
